...
var seedPermissions = []seedPermission{
	...
	{Code: "galgame:import", Name: "导入外部 Galgame", Description: "允许搜索、预览和单条导入外部数据源作品"},
	{Code: "galgame:import:batch", Name: "批量导入外部 Galgame", Description: "允许创建和查看外部数据源批量导入任务"},
	{Code: "galgame_classification:run", Name: "运行 AI 年龄分级", Description: "允许对 Galgame 启动、重试和批量执行 AI 年龄分级"},
	{Code: "galgame_classification:read", Name: "查看 AI 年龄分级", Description: "允许查看 AI 分级结果与证据"},
	{Code: "galgame_classification:apply", Name: "采用 AI 年龄分级", Description: "允许通过、拒绝、覆盖和批量采用 AI 分级结果"},
	{Code: "galgame_gallery:manage", Name: "管理游戏画面", Description: "允许上传、编辑、删除和排序 Galgame 游戏画面"},
	{Code: "galgame_gallery:review", Name: "审核游戏画面", Description: "允许审核游戏画面（通过 / 拒绝 / 批量审核）"},
	{Code: "novel:create", Name: "创建小说", Description: "允许创建小说条目"},
	{Code: "novel:update", Name: "更新小说", Description: "允许更新小说、管理卷册和关联作品"},
	{Code: "novel:delete", Name: "删除小说", Description: "允许删除小说"},
	{Code: "novel:review", Name: "审核小说", Description: "允许查看全部状态的小说并审核小说与卷册"},
	...
	{Code: "ip_audit:read", Name: "查看 IP 审计", Description: "允许查看用户完整 IP、详细属地和历史记录"},
	...
	{Code: "announcement:read", Name: "Read announcements", Description: "View announcements in administration"},
	{Code: "announcement:create", Name: "Create announcements", Description: "Create announcements"},
	{Code: "announcement:update", Name: "Update announcements", Description: "Update announcements"},
	{Code: "announcement:delete", Name: "Delete announcements", Description: "Delete announcements"},
	{Code: "announcement:publish", Name: "Publish announcements", Description: "Publish and withdraw announcements"},
	{Code: "app_release:read", Name: "Read app releases", Description: "View app releases in administration"},
	{Code: "app_release:create", Name: "Create app releases", Description: "Create app releases"},
	{Code: "app_release:update", Name: "Update app releases", Description: "Update app releases"},
	{Code: "app_release:delete", Name: "Delete app releases", Description: "Delete app releases"},
	{Code: "app_release:publish", Name: "Publish app releases", Description: "Publish and disable app releases"},
	{Code: "changelog:read", Name: "查看更新日志", Description: "允许查看管理端站点更新日志"},
	{Code: "changelog:create", Name: "创建更新日志", Description: "允许新增站点更新日志"},
	{Code: "changelog:update", Name: "更新更新日志", Description: "允许修改站点更新日志"},
	{Code: "changelog:delete", Name: "删除更新日志", Description: "允许删除站点更新日志"},
