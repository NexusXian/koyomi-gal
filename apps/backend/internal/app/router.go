...
func (app *App) setupRoutes() {
	...
	v1.GET("/announcements/active", app.AnnouncementHandler.ListActive)
	...
	admin := protected.Group("/admin")
	{
		...
		admin.GET("/announcements", requirePermission("announcement:read"), app.AnnouncementHandler.ListAdmin)
		admin.GET("/announcements/:id", requirePermission("announcement:read"), app.AnnouncementHandler.GetAdmin)
		admin.POST("/announcements", requirePermission("announcement:create"), app.AnnouncementHandler.CreateAdmin)
		admin.PUT("/announcements/:id", requirePermission("announcement:update"), app.AnnouncementHandler.UpdateAdmin)
		admin.DELETE("/announcements/:id", requirePermission("announcement:delete"), app.AnnouncementHandler.DeleteAdmin)
		...
		admin.DELETE("/app/releases/:id", requirePermission("app_release:delete"), app.AppReleaseHandler.DeleteAdmin)
		admin.PATCH("/app/releases/:id/publish", requirePermission("app_release:publish"), app.AppReleaseHandler.Publish)
		admin.PATCH("/app/releases/:id/disable", requirePermission("app_release:publish"), app.AppReleaseHandler.Disable)

		admin.GET("/changelogs", requirePermission("changelog:read"), app.ChangelogHandler.ListAdmin)
		admin.GET("/changelogs/:id", requirePermission("changelog:read"), app.ChangelogHandler.GetAdmin)
		admin.POST("/changelogs", requirePermission("changelog:create"), app.ChangelogHandler.Create)
		admin.PUT("/changelogs/:id", requirePermission("changelog:update"), app.ChangelogHandler.Update)
		admin.DELETE("/changelogs/:id", requirePermission("changelog:delete"), app.ChangelogHandler.Delete)
