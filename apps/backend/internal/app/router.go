...
func (app *App) setupRoutes() {
	...
	v1.GET("/novels/:id/volumes/:volumeId", app.NovelVolumeHandler.GetNovelVolume)
	...
	protected.DELETE("/novels/:id", requirePermission("novel:delete"), app.NovelHandler.DeleteNovel)
	...
	novelVolumes := protected.Group("/novels/:id")
	{
		novelVolumes.POST("/volumes", requirePermission("novel:update"), app.NovelVolumeHandler.CreateNovelVolume)
		novelVolumes.PUT("/volumes/order", requirePermission("novel:update"), app.NovelVolumeHandler.ReorderNovelVolumes)
		novelVolumes.PUT("/volumes/:volumeId", requirePermission("novel:update"), app.NovelVolumeHandler.UpdateNovelVolume)
		novelVolumes.DELETE("/volumes/:volumeId", requirePermission("novel:update"), app.NovelVolumeHandler.DeleteNovelVolume)
		novelVolumes.GET("/relations", requirePermission("novel:update"), app.NovelHandler.ListNovelRelations)
		novelVolumes.POST("/relations", requirePermission("novel:update"), app.NovelHandler.CreateNovelRelation)
		novelVolumes.DELETE("/relations/:relationId", requirePermission("novel:update"), app.NovelHandler.DeleteNovelRelation)
	}
	...
	admin := protected.Group("/admin")
	{
		...
		admin.POST("/galgames/classification/batch", requirePermission("galgame_classification:run"), app.ClassificationHandler.BatchClassification)
		admin.POST("/galgames/classification/batch-approve", requirePermission("galgame_classification:apply"), app.ClassificationHandler.BatchApproveClassification)
		...
		admin.GET("/novels", requirePermission("novel:review"), app.NovelAdminHandler.ListAdminNovels)
		admin.GET("/novels/:id", requirePermission("novel:review"), app.NovelAdminHandler.GetAdminNovel)
		admin.PUT("/novels/:id/review", requirePermission("novel:review"), app.NovelAdminHandler.ReviewNovel)
		admin.GET("/novel-volumes", requirePermission("novel:review"), app.NovelAdminHandler.ListAdminNovelVolumes)
		admin.PUT("/novel-volumes/:id/review", requirePermission("novel:review"), app.NovelAdminHandler.ReviewNovelVolume)
