...
type PresignImageRequest struct {
	...
	Category    string `json:"category" binding:"required,oneof=avatars posts comments galgames novels backgrounds banners profile-banners admin" example:"posts"`
}
...
type AdminImageQuery struct {
	...
	Category string `form:"category" binding:"omitempty,oneof=avatars posts comments galgames novels backgrounds banners profile-banners admin" example:"posts"`
