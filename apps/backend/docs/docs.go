    ...
    "paths": {
        ...
        "/api/v1/admin/characters": {
            "get": {
                ...
                "operationId": "searchAdminCharacters",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Search text (at most 255 characters)",
                        "name": "q",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.CharacterSearchResponse"
                        },
                        "headers": {
                            "Cache-Control": {
                                "type": "string",
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Shared character metadata; name is required",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "200": {
                        "description": "Created or existing unchanged character",
                        "schema": {
                            "$ref": "#/definitions/dto.CharacterDataResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/v1/admin/characters/{id}": {
            "put": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Shared character ID",
                        "name": "id",
                        "in": "path",
                        "required": true
                    },
                    {
                        "description": "Replacement metadata; name is required",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/admin/experience-rules": {
            "get": {
                ...
                "summary": "管理端查询经验规则",
                "operationId": "listAdminExperienceRules",
                "responses": {
                    "200": {
                        "description": "经验规则列表",
                        "schema": {
                            "$ref": "#/definitions/leveldto.ExperienceRuleListResponse"
                        }
                    },
                    "401": {
                        "description": "用户登录失效",
        ...
        "/api/v1/admin/experience-rules/{id}": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "summary": "更新经验规则",
                "operationId": "updateAdminExperienceRule",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "经验规则 ID",
                    ...
                    {
                        "description": "更新经验规则请求",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/leveldto.UpdateExperienceRuleRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "更新成功",
                        "schema": {
                            "$ref": "#/definitions/leveldto.ExperienceRuleDataResponse"
                        }
                    },
                    "400": {
                        "description": "请求参数格式不正确",
        ...
        "/api/v1/admin/galgames/classification": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "队列列表",
                        "schema": {
                            "$ref": "#/definitions/dto.ClassificationListResponse"
                        }
                    },
                    "400": {
                        "description": "查询参数格式不正确",
        ...
        "/api/v1/admin/galgames/{id}/characters": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "operationId": "listAdminGalgameCharacters",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Galgame ID",
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.GalgameCharacterListResponse"
                        },
                        "headers": {
                            "Cache-Control": {
                                "type": "string",
            ...
            "post": {
                ...
                "operationId": "bindGalgameCharacter",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Galgame ID",
                    ...
                    {
                        "description": "Character ID and association metadata",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.GalgameCharacterRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.GalgameCharacterDataResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/v1/admin/galgames/{id}/characters/{characterId}": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "operationId": "updateGalgameCharacter",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Galgame ID",
                    ...
                    {
                        "type": "integer",
                        "description": "Shared character ID, not relation ID",
                        "name": "characterId",
                        "in": "path",
                        "required": true
                    },
                    {
                        "description": "Replacement association metadata",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UpdateGalgameCharacterRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "delete": {
                ...
                "operationId": "unbindGalgameCharacter",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Galgame ID",
        ...
        "/api/v1/admin/galgames/{id}/classification/cancel": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "summary": "取消 AI 年龄分级",
                "operationId": "cancelClassification",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Galgame ID",
                ...
                "responses": {
                    ...
                    "404": {
                        "description": "该游戏还没有 AI 判断记录",
                        "schema": {
                            "$ref": "#/definitions/response.ErrorResponse"
                        }
                    },
                    "409": {
                        "description": "当前没有排队或进行中的任务",
                        "schema": {
                            "$ref": "#/definitions/response.ErrorResponse"
                        }
                    },
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "等级配置列表",
                        "schema": {
                            "$ref": "#/definitions/leveldto.LevelConfigListResponse"
                        }
                    },
                    "401": {
                        "description": "用户登录失效",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/leveldto.CreateLevelConfigRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "创建成功",
                        "schema": {
                            "$ref": "#/definitions/leveldto.LevelConfigDataResponse"
                        }
                    },
                    "400": {
                        "description": "请求参数格式不正确",
        ...
        "/api/v1/admin/levels/{id}": {
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/leveldto.UpdateLevelConfigRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "等级已删除或已禁用",
                        "schema": {
                            "$ref": "#/definitions/response.MessageResponse"
                        }
                    },
                    "400": {
                        "description": "等级配置 ID 格式不正确",
                        "schema": {
                            "$ref": "#/definitions/response.ErrorResponse"
                        }
                    },
        ...
        "/api/v1/admin/users/{id}/experience/adjust": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "summary": "管理员调整用户经验",
                "operationId": "adjustUserExperience",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "用户 ID",
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/leveldto.AdjustExperienceRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "调整后的等级概况",
                        "schema": {
                            "$ref": "#/definitions/leveldto.UserLevelResponse"
                        }
                    },
                    "400": {
                        "description": "请求参数格式不正确",
        ...
        "/api/v1/galgames/{id}/characters": {
            "get": {
                ...
                "operationId": "listGalgameCharacters",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Galgame ID",
                    ...
                    },
                    {
                        "type": "boolean",
                        "default": false,
                        "description": "Explicitly reveal all character identity and spoiler text",
                        "name": "spoiler",
                        "in": "query"
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid ID or spoiler query",
                        "schema": {
                            "$ref": "#/definitions/response.ErrorResponse"
                        }
                    },
                    "404": {
                        "description": "Galgame missing or not published",
                        "schema": {
                            "$ref": "#/definitions/response.ErrorResponse"
                        }
                    },
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "签到状态",
                        "schema": {
                            "$ref": "#/definitions/leveldto.CheckinStatusResponse"
                        }
                    },
                    "401": {
                        "description": "用户登录失效",
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "签到结果",
                        "schema": {
                            "$ref": "#/definitions/leveldto.CheckinResultResponse"
                        }
                    },
                    "401": {
                        "description": "用户登录失效",
        ...
        "/api/v1/users/me/experience/logs": {
            "get": {
                ...
                "summary": "查看我的经验流水",
                "operationId": "listMyExperienceLogs",
                "parameters": [
                    {
                        "type": "integer",
                        "default": 1,
                ...
                "responses": {
                    "200": {
                        "description": "经验记录列表",
                        "schema": {
                            "$ref": "#/definitions/leveldto.ExperienceLogListResponse"
                        }
                    },
                    "401": {
                        "description": "用户登录失效",
    ...
    "definitions": {
        ...
        "dto.CharacterSearchResponse": {
            ...
            "properties": {
                ...
                "data": {
                    "$ref": "#/definitions/dto.CharacterSearchData"
                },
                "msg": {
                    "type": "string",
                    "example": "success"
        ...
        "dto.ClassificationListData": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.ClassificationListItem"
                    }
                },
                "limit": {
                    "type": "integer",
        ...
        "dto.ClassificationListResponse": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "integer",
                ...
                "data": {
                    "$ref": "#/definitions/dto.ClassificationListData"
                },
                "msg": {
                    "type": "string",
                    "example": "success"
        ...
        "dto.GalgameCharacterDataResponse": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "integer",
                ...
                "data": {
                    "$ref": "#/definitions/dto.GalgameCharacterResponse"
                },
                "msg": {
                    "type": "string",
                    "example": "success"
        ...
        "dto.GalgameCharacterListResponse": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "integer",
                ...
                "data": {
                    "$ref": "#/definitions/dto.GalgameCharacterListData"
                },
                "msg": {
                    "type": "string",
                    "example": "success"
        ...
        "dto.UpdateGalgameCharacterRequest": {
            "type": "object",
            "properties": {
                "appearance_spoiler": {
                    "type": "boolean"
        ...
        "leveldto.CheckinResultResponse": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "integer",
                ...
                "data": {
                    "$ref": "#/definitions/leveldto.CheckinResultData"
                },
                "msg": {
                    "type": "string",
                    "example": "success"
        ...
        "leveldto.CheckinStatusResponse": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "integer",
                ...
                "data": {
                    "$ref": "#/definitions/leveldto.CheckinStatusData"
                },
                "msg": {
                    "type": "string",
                    "example": "success"
        ...
        "leveldto.CreateLevelConfigRequest": {
            "type": "object",
            "required": [
                "level",
                "min_exp",
        ...
        "leveldto.ExperienceLogListData": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/leveldto.ExperienceLogData"
                    }
                },
                "limit": {
                    "type": "integer",
        ...
        "leveldto.ExperienceLogListResponse": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "integer",
                ...
                "data": {
                    "$ref": "#/definitions/leveldto.ExperienceLogListData"
                },
                "msg": {
                    "type": "string",
                    "example": "success"
        ...
        "leveldto.ExperienceRuleDataResponse": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "integer",
                ...
                "data": {
                    "$ref": "#/definitions/leveldto.ExperienceRuleData"
                },
                "msg": {
                    "type": "string",
                    "example": "success"
        ...
        "leveldto.ExperienceRuleListData": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
        ...
        "leveldto.ExperienceRuleListResponse": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "integer",
                ...
                "data": {
                    "$ref": "#/definitions/leveldto.ExperienceRuleListData"
                },
                "msg": {
                    "type": "string",
                    "example": "success"
        ...
        "leveldto.LevelConfigDataResponse": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "integer",
                ...
                "data": {
                    "$ref": "#/definitions/leveldto.LevelConfigData"
                },
                "msg": {
                    "type": "string",
                    "example": "success"
        ...
        "leveldto.LevelConfigListResponse": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "integer",
                ...
                "data": {
                    "$ref": "#/definitions/leveldto.LevelConfigListData"
                },
                "msg": {
                    "type": "string",
                    "example": "success"
        ...
        "leveldto.UpdateExperienceRuleRequest": {
            "type": "object",
            "properties": {
                "cooldown_seconds": {
                    "type": "integer",
        ...
        "leveldto.UpdateLevelConfigRequest": {
            "type": "object",
            "required": [
                "is_enabled",
                "min_exp",
        ...
        "leveldto.UserLevelResponse": {
            ...
            "properties": {
                ...
                "data": {
                    "$ref": "#/definitions/leveldto.UserLevelData"
                },
                "msg": {
                    "type": "string",
                    "example": "success"
